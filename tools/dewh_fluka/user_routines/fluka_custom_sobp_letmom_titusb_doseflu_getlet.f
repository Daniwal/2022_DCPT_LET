...
*                                                                      *
     ...
     &                                   NSURF )
      ...
      IF ( IJ .EQ. 1 .AND. ISCRNG .EQ. 2 ) THEN
         ...
         ELSE IF ( TITUSB(JSCRNG) .EQ. '      PWL1' ) THEN
            MATLET = 28
            LETW = GETLET(IJ, EKIN, PLA, ZERZER, MATLET)
            FLUSCW = LETW

         ELSE IF ( TITUSB(JSCRNG) .EQ. '      PWL2' ) THEN
            MATLET = 28
            LETW = GETLET(IJ, EKIN, PLA, ZERZER, MATLET)
            FLUSCW = LETW * LETW

         ELSE IF ( TITUSB(JSCRNG) .EQ. '      PRI_' ) THEN
            IF ( LTRACK .EQ. 1 ) THEN
               FLUSCW = ONEONE
            ELSE
               FLUSCW = ZERZER
         ...
         ELSE IF ( TITUSB(JSCRNG) .EQ. '      PRL1' ) THEN
            IF ( LTRACK .EQ. 1 ) THEN
               MATLET = MEDFLK(NREG,1)
               LETW = GETLET(IJ, EKIN, PLA, ZERZER, MATLET)
               FLUSCW = LETW
         ...
         ELSE IF ( TITUSB(JSCRNG) .EQ. '      PRL2' ) THEN
            IF ( LTRACK .EQ. 1 ) THEN
               MATLET = MEDFLK(NREG,1)
               LETW = GETLET(IJ, EKIN, PLA, ZERZER, MATLET)
               FLUSCW = LETW * LETW
         ...
         ELSE IF ( TITUSB(JSCRNG) .EQ. '      PWR1' ) THEN
            IF ( LTRACK .EQ. 1 ) THEN
               MATLET = 28
               LETW = GETLET(IJ, EKIN, PLA, ZERZER, MATLET)
               FLUSCW = LETW
         ...
         ELSE IF ( TITUSB(JSCRNG) .EQ. '      PWR2' ) THEN
            IF ( LTRACK .EQ. 1 ) THEN
               MATLET = 28
               LETW = GETLET(IJ, EKIN, PLA, ZERZER, MATLET)
               FLUSCW = LETW * LETW
