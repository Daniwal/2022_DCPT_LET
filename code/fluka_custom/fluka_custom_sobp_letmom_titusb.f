...
*                                                                      *
     ...
     &                                   NSURF )
      ...
      DOUBLE PRECISION EDEDX(NDEDX), SDEDX(NDEDX)
      DOUBLE PRECISION EKIN, EMEV, LETW, RHO
      DOUBLE PRECISION E1, E2, S1, S2, FRAC, MASSDEDX

      DATA EDEDX /
     & 2.50000000D-02, 3.00000000D-02, 4.00000000D-02,
     & 5.00000000D-02, 6.00000000D-02, 7.00000000D-02,
     & 8.00000000D-02, 9.00000000D-02, 1.00000000D-01,
     & 1.50000000D-01, 2.00000000D-01, 2.50000000D-01,
     & 3.00000000D-01, 4.00000000D-01, 5.00000000D-01,
     & 6.00000000D-01, 7.00000000D-01, 8.00000000D-01,
     & 9.00000000D-01, 1.00000000D+00, 1.50000000D+00,
     & 2.00000000D+00, 2.50000000D+00, 3.00000000D+00,
     & 4.00000000D+00, 5.00000000D+00, 6.00000000D+00,
     & 7.00000000D+00, 8.00000000D+00, 9.00000000D+00,
     & 1.00000000D+01, 1.50000000D+01, 2.00000000D+01,
     & 2.50000000D+01, 3.00000000D+01, 4.00000000D+01,
     & 5.00000000D+01, 6.00000000D+01, 7.00000000D+01,
     & 8.00000000D+01, 9.00000000D+01, 1.00000000D+02,
     & 1.50000000D+02, 2.00000000D+02, 2.50000000D+02,
     & 3.00000000D+02, 4.00000000D+02, 5.00000000D+02,
     & 6.00000000D+02, 7.00000000D+02, 8.00000000D+02,
     & 9.00000000D+02, 1.00000000D+03
     & /
      DATA SDEDX /
     & 6.19820000D+02, 6.62800000D+02, 7.29000000D+02,
     & 7.74000000D+02, 8.02600000D+02, 8.18390000D+02,
     & 8.24100000D+02, 8.22160000D+02, 8.14500000D+02,
     & 7.36000000D+02, 6.58500000D+02, 5.95470000D+02,
     & 5.43500000D+02, 4.64300000D+02, 4.06500000D+02,
     & 3.62400000D+02, 3.27620000D+02, 2.99700000D+02,
     & 2.76710000D+02, 2.57400000D+02, 1.93400000D+02,
     & 1.56900000D+02, 1.32780000D+02, 1.16000000D+02,
     & 9.31900000D+01, 7.84200000D+01, 6.80100000D+01,
     & 6.02010000D+01, 5.41700000D+01, 4.93190000D+01,
     & 4.53200000D+01, 3.26900000D+01, 2.58900000D+01,
     & 2.15530000D+01, 1.86400000D+01, 1.47900000D+01,
     & 1.23800000D+01, 1.07200000D+01, 9.50050000D+00,
     & 8.57800000D+00, 7.84630000D+00, 7.25000000D+00,
     & 5.41700000D+00, 4.47000000D+00, 3.88440000D+00,
     & 3.50400000D+00, 3.01800000D+00, 2.73100000D+00,
     & 2.54400000D+00, 2.41450000D+00, 2.32300000D+00,
     & 2.25510000D+00, 2.20300000D+00
     & /
      ...
      IF ( IJ .EQ. 1 .AND. ISCRNG .EQ. 2 ) THEN
         ...
         EKIN = -PLA
         EMEV = 1000.0D+00 * EKIN

         RHO = 1.0D+00

         IF ( EMEV .LE. EDEDX(1) ) THEN
            MASSDEDX = SDEDX(1)
         ELSE IF ( EMEV .GE. EDEDX(NDEDX) ) THEN
            MASSDEDX = SDEDX(NDEDX)
         ELSE
            DO I = 1, NDEDX-1
               IF ( EMEV .GE. EDEDX(I) .AND.
     &              EMEV .LT. EDEDX(I+1) ) THEN
                  E1 = EDEDX(I)
                  E2 = EDEDX(I+1)
                  S1 = SDEDX(I)
                  S2 = SDEDX(I+1)
                  FRAC = ( EMEV - E1 ) / ( E2 - E1 )
                  MASSDEDX = S1 + FRAC * ( S2 - S1 )
                  GOTO 100
               END IF
            END DO
 100        CONTINUE
